...
def NeRFDeltaView():
    ...
    def zBuffer(obj, key):
        ...
        Notes:
        ------
        This function toggles Z-buffer preservation for the isosurface, color uncertainty, and 
        density uncertainty renderers based on the global variable 'radio_button_opacity'. 
        ...
        Z-buffer preservation is turned off for all renderers. Finally, 
        render updates are triggered for all interactor windows to reflect the changes.
        """
